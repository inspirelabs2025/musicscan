      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6 px-4">
        <Card variant="default" className="hover:bg-accent/50 transition-all duration-300">
          <CardContent className="p-4 md:p-6 text-center">
            ...
            <div className="text-xs md:text-sm text-muted-foreground">Albums</div>
        ...
        <Card variant="default" className="hover:bg-accent/50 transition-all duration-300">
          <CardContent className="p-4 md:p-6 text-center">
            ...
            <div className="text-xs md:text-sm text-muted-foreground">Artiesten</div>
            <div className="text-xs text-muted-foreground/70 mt-1">{stats.uniqueGenres} genres</div>
          </CardContent>
        </Card>
        ...
        <Card variant="default" className="hover:bg-accent/50 transition-all duration-300">
          <CardContent className="p-4 md:p-6 text-center">
            ...
            <div className="text-xs md:text-sm text-muted-foreground">Jaar Geschiedenis</div>
            <div className="text-xs text-muted-foreground/70 mt-1">
        ...
        <Card variant="default" className="hover:bg-accent/50 transition-all duration-300">
          <CardContent className="p-4 md:p-6 text-center">
            ...
            <div className="text-xs md:text-sm text-muted-foreground">Totale Waarde</div>
            <div className="text-xs text-muted-foreground/70 mt-1">
