...
import { Home, ShoppingCart, Menu, X, Images, Brain, LogOut, User, Music, Store, Newspaper, ScanLine, ChevronDown, Library, LogIn, BarChart3, MessageCircle, LayoutDashboard, Trophy, Users, DollarSign, Archive, Clock, Heart, Package, Headphones, Calendar, BookOpen, Sparkles, CircleDot } from "lucide-react";
          ...
          <NavigationMenuList className="gap-1">
            ...
            <NavigationMenuItem>
              <NavigationMenuTrigger className={cn(
                "group inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50",
                isShopPageActive && "bg-accent text-accent-foreground"
              )}>
            ...
            <NavigationMenuItem>
              <NavigationMenuTrigger className={cn(
                "group inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50",
                isVerhalenPageActive && "bg-accent text-accent-foreground"
              )}>
              ...
              {/* Mobile Search - REMOVED */}
               ...
               <nav className="flex flex-col flex-1 p-4 space-y-1 overflow-y-auto">
                 ...
                 <div className="mt-2">
                   <Button
                     ...
                     className={cn(
                       ...
                       isShopPageActive && "bg-muted text-primary"
                     )}
                   >
                 ...
                 <div className="mt-2">
                   <Button
                     variant="ghost"
                     onClick={() => setIsVerhalenMenuOpen(!isVerhalenMenuOpen)}
                     className={cn(
                       "w-full justify-start text-muted-foreground hover:text-primary",
                       isVerhalenPageActive && "bg-muted text-primary"
                     )}
                   >
                     <Newspaper className="h-4 w-4 mr-3" />
                     <span className="text-base">Verhalen</span>
                     <ChevronDown className={cn(
                       "h-4 w-4 ml-auto transition-transform",
                       isVerhalenMenuOpen && "rotate-180"
                     )} />
                   </Button>
                   {isVerhalenMenuOpen && (
                     <div className="ml-6 mt-1 space-y-1">
