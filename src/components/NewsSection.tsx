  ...
  return <section className="py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {!loading && !error && newsSource === 'discogs' && <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {discogsReleases.map(release => <Card key={release.id} className="group hover:shadow-lg transition-all duration-300 overflow-hidden">
                <CardHeader className="pb-3">
        ...
        {!loading && !error && newsSource === 'perplexity' && <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {musicNews.map((item, index) => <Card key={index} className="group hover:shadow-lg transition-all duration-300">
                <CardHeader className="pb-3">
