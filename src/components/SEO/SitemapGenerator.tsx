...
import { generateSitemap, getStaticRoutes, getBlogPostRoutes, type SitemapEntry } from '@/utils/sitemap';
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-sm text-muted-foreground">
          <p>• Volledige sitemap bevat alle statische pagina's + blog posts</p>
