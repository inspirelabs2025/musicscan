...
export function SitemapStatus() {
  ...
  const sitemapUrls = [
    { name: "Hoofd Sitemap", url: "https://musicscans.com/sitemap.xml" },
    { name: "Blog Posts", url: "https://musicscans.com/sitemaps/sitemap-blog.xml" },
    { name: "Music Stories", url: "https://musicscans.com/sitemaps/sitemap-music-stories.xml" },
    { name: "Products", url: "https://musicscans.com/sitemaps/sitemap-products.xml" },
    { name: "Blog Images", url: "https://musicscans.com/sitemaps/sitemap-images-blogs.xml" },
    { name: "Story Images", url: "https://musicscans.com/sitemaps/sitemap-images-stories.xml" },
    { name: "Product Images", url: "https://musicscans.com/sitemaps/sitemap-images-products.xml" },
  ];
