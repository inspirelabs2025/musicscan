      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-green-500/20 rounded-full mb-4">
            ...
            <span className="text-green-400 text-sm">Nieuwe Releases</span>
          </div>
          <h2 className="text-3xl font-bold">Laatste Dance Releases</h2>
          <p className="text-muted-foreground mt-2">Vers uit de studio</p>
        </div>
                ...
                >
                  <Card className="overflow-hidden bg-background/50 hover:bg-background transition-colors border-transparent hover:border-green-500/50">
                    <div className="aspect-square relative overflow-hidden">
                      <img
                        src={release.image_url || '/placeholder.svg'}
                    ...
                    <CardContent className="p-3">
                      <h3 className="font-semibold text-sm line-clamp-1 group-hover:text-green-400 transition-colors">
                        {release.album_name}
                      </h3>
        ...
        {(!releases || releases.length === 0) && !isLoading && (
          <div className="text-center py-12">
            <p className="text-muted-foreground">Momenteel geen dance releases beschikbaar.</p>
          </div>
        )}
        ...
        {releases && releases.length > 0 && (
          <div className="text-center mt-8">
            <a
              href="https://open.spotify.com/genre/electronic"
              target="_blank"
              rel="noopener noreferrer"
              className="text-green-400 hover:text-green-300 text-sm font-medium inline-flex items-center gap-2"
            >
              Meer op Spotify
