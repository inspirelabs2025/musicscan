    ...
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full mb-6">
          ...
          <span className="text-white/90 text-sm font-medium">Filmmuziek Genre Hub</span>
        </div>
        ...
        <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto mb-10">
          Van John Williams' epische orkesten tot Hans Zimmer's moderne hybrids. 
          Ontdek de magie van filmmuziek die emoties tot leven brengt.
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/10">
            ...
            <div className="text-white/60 text-sm">Mijlpalen</div>
          </div>
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/10">
            ...
            <div className="text-white/60 text-sm">Componisten</div>
          </div>
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/10">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/10">
            ...
            <div className="text-white/60 text-sm">Jaar Oscars</div>
          </div>
        </div>
      </div>
