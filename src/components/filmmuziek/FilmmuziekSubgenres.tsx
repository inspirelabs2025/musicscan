      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-amber-500/20 rounded-full mb-4">
            ...
            <span className="text-amber-400 text-sm">{fm.discoverStyles}</span>
          </div>
          <h2 className="text-3xl font-bold">{fm.filmMusicGenres}</h2>
          <p className="text-muted-foreground mt-2">{fm.genresSubtitle}</p>
        </div>
