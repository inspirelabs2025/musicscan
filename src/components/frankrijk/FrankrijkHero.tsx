      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-4">
            Franse <span className="text-[#0055A4]">Muziek</span>
          </h1>

          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Van Édith Piaf tot Daft Punk, van chanson tot French house.
            Ontdek het beste van de Franse muziekscène.
          </p>
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-2xl mx-auto">
            <div className="bg-background/30 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-border/50">
              <div className="flex justify-center mb-2">
                <Disc className="h-6 w-6 text-[#0055A4]" />
              </div>
              <div className="text-2xl md:text-3xl font-bold text-foreground">
                {isLoading ? "..." : stats?.releases || 0}
              </div>
            ...
            <div className="bg-background/30 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-border/50">
              <div className="flex justify-center mb-2">
                <BookOpen className="h-6 w-6 text-[#EF4135]" />
              </div>
              <div className="text-2xl md:text-3xl font-bold text-foreground">
                {isLoading ? "..." : stats?.verhalen || 0}
              </div>
              <div className="text-sm text-muted-foreground">Verhalen</div>
            </div>
          </div>

          {/* Decorative Elements */}
          <div className="mt-12 flex justify-center gap-4">
            <span className="px-4 py-2 bg-[#0055A4]/20 rounded-full text-sm text-foreground border border-[#0055A4]/30">
              Chanson Française
            </span>
            <span className="px-4 py-2 bg-background/20 rounded-full text-sm text-foreground border border-border/30">
              French House
            </span>
            <span className="px-4 py-2 bg-[#EF4135]/20 rounded-full text-sm text-foreground border border-[#EF4135]/30">
              Yé-yé
            </span>
          </div>
        </div>
