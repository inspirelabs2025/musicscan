...
const BASE_PROMO_BLOCKS: Array<{
  ...
  { id: 'promo-scan', type: 'scan', title: 'Scan Je Albums', subtitle: 'Digitaliseer je collectie', link: '/ai-scan-v2?tab=chat', emoji: '📷', image: promoScanBg },
  { id: 'promo-echo', type: 'echo', title: 'Chat met Magic Mike', subtitle: 'Onze muziekdetective', link: '/echo', emoji: '🎩', image: echoAvatar, forceSmall: true },
  selectedCountry,
