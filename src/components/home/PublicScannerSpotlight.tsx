...
export const PublicScannerSpotlight = () => {
  return (
    <section className="py-10 md:py-14 bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10 border-y border-primary/20">
      <div className="container max-w-5xl mx-auto px-4">
        <div className="bg-card/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-xl border border-primary/20">
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/10 rounded-full text-xs font-medium text-primary mb-3">
