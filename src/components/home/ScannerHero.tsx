      ...
      <div className="container relative z-10 py-16 md:py-24 text-center">
        <div className="mb-8 md:mb-12">
          ...
          <Button
            asChild
            size="lg"
            className="w-full max-w-[480px] mx-auto bg-black hover:bg-neutral-900 text-white font-bold text-xl md:text-2xl px-10 md:px-14 py-8 md:py-10 rounded-2xl shadow-2xl shadow-black/40 hover:shadow-black/60 transition-all duration-300 hover:scale-105 group border border-white/10"
          >
            <Link to="/ai-scan-v2">
