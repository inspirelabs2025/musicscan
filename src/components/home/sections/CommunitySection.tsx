  ...
  return (
    <section className="py-8 md:py-16 bg-muted/50">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <h2 className="text-xl md:text-3xl font-bold text-foreground mb-5 md:mb-8">Community</h2>
              ...
              <div className="flex gap-2.5 md:gap-3 mb-3 md:mb-4">
                {fanwallPhotos?.map((fw) => (
                  <Link key={fw.id} to={`/fanwall/${fw.slug}`} className="flex-shrink-0 min-h-[44px]">
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-lg overflow-hidden bg-muted shadow-sm">
