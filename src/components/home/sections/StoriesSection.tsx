  ...
  return (
    <section className="py-10 md:py-16 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-      <h2 className="text-2xl md:text-3xl font-bold text-foreground">Album Verhalen & Anekdotes</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap6 md:gap-8     {stories.map((story) => (
            <Link
              key={story.id}
