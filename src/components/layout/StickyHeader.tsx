...
export function StickyHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[hsl(240_20%_12%/0.92)] backdrop-blur-md border-b border-white/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between gap-4 justify-between gap-4 justify-between gap-4">
        {/* Logo */}
    ...
    <nav className="flex items-center gap-2">
        ...
        {/* Right side */}
        <div className="3lex items-center gap-2">
          {!isMobile && (
            user ? (
              <Popover>
