...
const CONDITION_OPTIONS = {
  vinyl: [
    { value: 'Mint (M)', label: 'Mint (M)', desc: 'Perfect, nieuwstaat' },
    { value: 'Near Mint (NM or M-)', label: 'Near Mint (NM)', desc: 'Bijna perfect' },
    { value: 'Very Good Plus (VG+)', label: 'Very Good Plus (VG+)', desc: 'Lichte gebruikssporen' },
    { value: 'Very Good (VG)', label: 'Very Good (VG)', desc: 'Duidelijke gebruikssporen' },
    { value: 'Good Plus (G+)', label: 'Good Plus (G+)', desc: 'Zichtbare slijtage' },
    { value: 'Good (G)', label: 'Good (G)', desc: 'Duidelijke slijtage' },
    { value: 'Fair (F) / Poor (P)', label: 'Fair / Poor', desc: 'Slechte staat' },
  ],
  cd: [
    { value: 'Mint (M)', label: 'Mint (M)', desc: 'Perfect, nieuwstaat' },
    { value: 'Near Mint (NM)', label: 'Near Mint (NM)', desc: 'Bijna perfect' },
    { value: 'Very Good Plus (VG+)', label: 'Very Good Plus (VG+)', desc: 'Lichte gebruikssporen' },
    { value: 'Very Good (VG)', label: 'Very Good (VG)', desc: 'Duidelijke gebruikssporen' },
    { value: 'Good Plus (G+)', label: 'Good Plus (G+)', desc: 'Zichtbare slijtage' },
    { value: 'Good (G)', label: 'Good (G)', desc: 'Duidelijke slijtage' },
          ...
          <div className="grid grid-cols-3 gap-2">
            {pricingStats?.lowest_price && (
              <div className="text-center p-2 bg-green-50 dark:bg-green-950/20 rounded-lg">
                <div className="text-xs text-green-700 dark:text-green-400">Laagste</div>
            ...
            {pricingStats?.median_price && (
              <div className="text-center p-2 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
                <div className="text-xs text-blue-700 dark:text-blue-400">Mediaan</div>
            ...
            {pricingStats?.highest_price && (
              <div className="text-center p-2 bg-red-50 dark:bg-red-950/20 rounded-lg">
                <div className="text-xs text-red-700 dark:text-red-400">Hoogste</div>
