            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <Link to="/mijn-collectie" className="flex flex-col items-center justify-center gap-2 h-24 rounded-xl font-semibold text-sm transition-all duration-300 hover:scale-[1.03] group" style={{ background: 'rgba(255,255,255,0.92)', border: '1px solid rgba(255,255,255,0.95)', color: 'hsl(270 60% 30%)', backdropFilter: 'blur(4px)' }}>
