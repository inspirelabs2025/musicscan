    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('threads-token-exchange', {
        body: { 
          ...
          redirect_uri: 'https://musicscans.com/'
        }
      });
          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-4 bg-purple-500/10 border-2 border-purple-500/30 rounded-lg space-y-4">
              ...
              <div className="text-sm space-y-3">
                ...
                <a 
                  href={`https://threads.net/oauth/authorize?client_id=${threadsAppId || '1484849229994956'}&redirect_uri=https://musicscans.com/&scope=threads_basic,threads_content_publish&response_type=code`}
                  target="_blank"
