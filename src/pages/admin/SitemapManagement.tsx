...
export default function SitemapManagement() {
  ...
  const sitemaps = [
    { name: 'Main Index', url: 'https://musicscans.com/sitemap.xml', type: 'index' },
    { name: 'Static Pages', url: 'https://musicscans.com/sitemaps/sitemap-static.xml', type: 'static' },
    { name: 'Blog Posts', url: 'https://musicscans.com/sitemaps/sitemap-blog.xml', type: 'content', count: stats?.blogs },
    { name: 'Music Stories', url: 'https://musicscans.com/sitemaps/sitemap-music-stories.xml', type: 'content', count: stats?.stories },
    { name: 'Products', url: 'https://musicscans.com/sitemaps/sitemap-products.xml', type: 'content', count: stats?.products },
    { name: 'Blog Images', url: 'https://musicscans.com/sitemaps/sitemap-images-blogs.xml', type: 'images' },
    { name: 'Story Images', url: 'https://musicscans.com/sitemaps/sitemap-images-stories.xml', type: 'images' },
    { name: 'Product Images', url: 'https://musicscans.com/sitemaps/sitemap-images-products.xml', type: 'images' },
  ];
        ...
        <AlertDescription>
          ...
          <div className="mt-2">
            ...
            <ul className="list-disc ml-6 mt-2">
              <li><code>https://musicscans.com/sitemap.xml</code></li>
            </ul>
          </div>
        </AlertDescription>
      </Alert>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <Button
              variant="outline"
              onClick={() => window.open('https://musicscans.com/sitemap-llm.xml', '_blank')}
            >
