-- Create pg_cron job for rss-news-rewriter to run at 8:00, 14:00, and 20:00 UTC
SELECT cron.schedule(
  'rss-news-rewriter-cron',
  '0 8,14,20 * * *',
  $$
  SELECT net.http_post(
    url := 'https://ssxbpyqnjfiyubsuonar.supabase.co/functions/v1/rss-news-rewriter',
