-- Create cron job for scheduling music history posts (runs at 6:05 AM UTC, after events are generated at 6:00 AM)
...
-- Create cron job for posting scheduled music history events (runs every hour at minute 0)
SELECT cron.schedule(
