-- Create cron job for christmas batch processor (runs every minute)
SELECT
  cron.schedule(
    'christmas-batch-processor-job',
    '* * * * *',
    $$
    SELECT
      net.http_post(
          url:='https://ssxbpyqnjfiyubsuonar.supabase.co/functions/v1/christmas-batch-processor',
