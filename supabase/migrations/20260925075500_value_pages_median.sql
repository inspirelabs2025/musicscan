-- De vork alleen is te ruim om nuttig te zijn (Déjà Vu loopt van 6 tot 150);
-- de mediaan erbij maakt hem leesbaar. price_sources[0] is het aggregaat per
-- bron, zoals sectie 4 van de bouwspecificatie voorschrijft.
